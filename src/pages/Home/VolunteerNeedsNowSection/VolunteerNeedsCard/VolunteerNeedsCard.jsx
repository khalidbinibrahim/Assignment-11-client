...
const VolunteerNeedsCard = ({ volunteer }) => {
    ...
    const { _id, thumbnail, postTitle, category, deadline, location, volunteersNeeded } = volunteer;
    ...
    return (
        <>
            {volunteersNeeded > 0 ? (
                ...
                <div className="bg-gray-200 p-2 rounded-md overflow-hidden mx-auto shadow-xl">
                    <p className='font-poppins font-medium'>No volunteers needed for this post.</p>
                </div>
            )}
        </>
    );
